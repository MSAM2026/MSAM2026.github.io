...
<div class="program-talk"><span class="talk-time">11:50 – 12:20</span> <span class="talk-speaker">Wenfei Li</span> <span class="talk-affiliation">(Nanjing University)</span>
<details class="talk-details"><summary>Molecular simulations of HBV pregenome organization driven by phase separation</summary>
<div class="talk-abstract">The viral genome encodes the genetic information and processes essential for viral life cycle. In this talk, I will present our study on the structure and dynamics of the hepatitis B virus (HBV) pgRNA intermediate using multiscale molecular dynamics simulations. The molecular simulation results show that pgRNA exploits liquid–liquid phase separation (LLPS) within the capsid to form microphases of aligned RNA hairpins interspersed with flexible linkers, balancing structural order and dynamic flexibility. This LLPS-induced hollow-shell architecture promotes long-range base-pairing and enhances polymerase mobility, thereby facilitating reverse transcription. The discussion will also extend to LLPS-driven liquid–solid transitions in proteins implicated in neurodegeneration.</div>
</details></div>
